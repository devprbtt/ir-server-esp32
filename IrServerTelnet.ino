...
static const unsigned long kDinplugLearnTimeoutMs = 10000;
...
bool dinplugLearnActive = false;
bool dinplugLearnReady = false;
uint16_t dinplugLearnKeypadId = 0;
uint16_t dinplugLearnButtonId = 0;
uint16_t dinplugLearnSuppressKeypadId = 0;
uint16_t dinplugLearnSuppressButtonId = 0;
unsigned long dinplugLearnStartMs = 0;
DNSServer dnsServer;
